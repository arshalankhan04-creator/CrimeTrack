    ...
    <div className="space-y-6">
      ...
      <div className="card-surface p-6">
        <div className="flex items-center justify-between">
          ...
          <span className="badge-success font-bold">15 / 15 Milestones Completed (100% Production Ready)</span>
        </div>
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-emerald-50/70 border border-emerald-200 rounded-lg">
            <span className="text-[10px] font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded flex items-center gap-1 w-fit">
              <CheckCircle2 className="w-3 h-3" /> M6 COMPLETED
            </span>
          ...
          <div className="p-4 bg-emerald-50/70 border border-emerald-200 rounded-lg">
            <span className="text-[10px] font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded flex items-center gap-1 w-fit">
              <CheckCircle2 className="w-3 h-3" /> M10 COMPLETED
            </span>
            <p className="font-semibold text-xs text-navy-900 mt-2">Reports & Data Export</p>
            <p className="text-[11px] text-slate-600 mt-1">CSV/JSON exports, printable official sheets, parameter filtering.</p>
          </div>

          <div className="p-4 bg-emerald-50/70 border border-emerald-200 rounded-lg">
            <span className="text-[10px] font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded flex items-center gap-1 w-fit">
              <CheckCircle2 className="w-3 h-3" /> M11 COMPLETED
            </span>
            <p className="font-semibold text-xs text-navy-900 mt-2">Audit Logs & Security Trails</p>
            <p className="text-[11px] text-slate-600 mt-1">Immutable audit trails, diff inspection, CSV compliance export.</p>
          </div>

          <div className="p-4 bg-emerald-50/70 border border-emerald-200 rounded-lg">
            <span className="text-[10px] font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded flex items-center gap-1 w-fit">
              <CheckCircle2 className="w-3 h-3" /> M12 COMPLETED
            </span>
            <p className="font-semibold text-xs text-navy-900 mt-2">Undo & Audit Recovery</p>
            <p className="text-[11px] text-slate-600 mt-1">State-aware rollbacks, non-destructive recovery, historical snapshots.</p>
          </div>

          <div className="p-4 bg-emerald-50/70 border border-emerald-200 rounded-lg">
            <span className="text-[10px] font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded flex items-center gap-1 w-fit">
              <CheckCircle2 className="w-3 h-3" /> M13 COMPLETED
            </span>
            <p className="font-semibold text-xs text-navy-900 mt-2">Citizen & Officer Feedback</p>
            <p className="text-[11px] text-slate-600 mt-1">Satisfaction ratings, bug reporting, admin triage and response system.</p>
          </div>

          <div className="p-4 bg-emerald-50/70 border border-emerald-200 rounded-lg">
            <span className="text-[10px] font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded flex items-center gap-1 w-fit">
              <CheckCircle2 className="w-3 h-3" /> M14 COMPLETED
            </span>
            <p className="font-semibold text-xs text-navy-900 mt-2">Automated QA & Diagnostics</p>
            <p className="text-[11px] text-slate-600 mt-1">34/34 automated regression assertions, telemetry, live diagnostic runner.</p>
          </div>

          <div className="p-4 bg-emerald-50/70 border border-emerald-200 rounded-lg">
            <span className="text-[10px] font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded flex items-center gap-1 w-fit">
              <CheckCircle2 className="w-3 h-3" /> M15 COMPLETED
            </span>
            <p className="font-semibold text-xs text-navy-900 mt-2">Final Polish & Delivery</p>
            <p className="text-[11px] text-slate-600 mt-1">Graceful shutdown, process guards, 100% production-ready delivery.</p>
          </div>
        </div>
      </div>
    </div>
